 ...
 * Fully rebuilt with real TK content
 */
...
async function sendAskTeamButton(to) {
  return sendMessage({
    ...
    interactive: {
      ...
      action: { buttons: [{ type: "reply", reply: { id: "ask_team", title: "💛 Ask our team" } }] }
    }
  });
}
    ...
    interactive: {
      ...
      action: {
        ...
        sections: [{ title: "Participant Topics", rows: [
          ...
          { id: "batch_support",   title: "Support",              description: "Issues & help" },
        ]}]
      }
    }
  });
...
async function handleIncoming(message) {
  ...
  if (type === "interactive" && message.interactive?.type === "button_reply") {
    if (message.interactive.button_reply.id === "ask_team") {
